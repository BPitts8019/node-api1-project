...
| --------- | -------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| POST   :clock5:| /api/users     | Creates a user using the information sent inside the `request body`.                                                              |
| GET    :heavy_check_mark:| /api/users     | Returns an array of all the user objects contained in the database.                                                               |
| GET    :heavy_check_mark:| /api/users/:id | Returns the user object with the specified `id`.                                                                                  |
